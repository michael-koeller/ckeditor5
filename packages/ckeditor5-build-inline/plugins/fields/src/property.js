	...
	init() {
		...
		editor.conversion.for( 'upcast' ).elementToElement( {
			...
			model: ( viewElement, conversionApi ) => {
				return conversionApi.writer.createElement( PROPERTY, { alias: viewElement.getAttribute( 'data-alias' ) } );
			}
		} );
		...
		editor.conversion.for( 'dataDowncast' ).elementToElement( {
			...
			view: ( modelElement, conversionApi ) => {
				return conversionApi.writer.createEditableElement( 'x-field', {
					class: PROPERTY,
		...
		editor.conversion.for( 'editingDowncast' ).elementToElement( {
			...
			view: ( modelElement, conversionApi ) => {
				...
				const w = toWidgetEditable( el, conversionApi.writer );
				enablePlaceholder( {
